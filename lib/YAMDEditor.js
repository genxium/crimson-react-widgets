...
var YAMDEditor = React.createClass({
  ...
  render: function render() {
    ...
    var SinglePicker = props.SinglePicker;
    var SinglePickerItem = props.SinglePickerItem;
    var onContentChangedBridge = props.onContentChangedBridge;

    var shouldHideShortcutBar = undefined == props.shouldHideShortcutBar || null == props.shouldHideShortcutBar ? true : shouldHideShortcutBar;
