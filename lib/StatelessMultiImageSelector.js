...
var StatelessMultiImageSelector = function (_React$Component) {
  ...
  function StatelessMultiImageSelector(props) {
    ...
    return _possibleConstructorReturn(this, (StatelessMultiImageSelector.__proto__ || Object.getPrototypeOf(StatelessMultiImageSelector)).call(this, props));
  }
  ...
  _createClass(StatelessMultiImageSelector, [{
    ...
    value: function render() {
      ...
      var onSingleNewBundleCreatedBridge = props.onSingleNewBundleCreatedBridge;
      ...
      var uploadEndpoint = props.uploadEndpoint;
      var singleUploadCredentialsEndpoint = props.singleUploadCredentialsEndpoint;
      ...
      var bundleList = bundleListManager.bundleList;
      var selectorList = [];
      var idleSelectorExists = false;

      var _loop = function _loop(i) {
        var bundle = bundleList[i];
        var isIdle = SINGLE_UPLOADER_STATE.IDLE == bundle.uploaderState;
        var shouldHide = idleSelectorExists && isIdle;
        var singleSelector = React.createElement(
          ...
          React.createElement(StatelessSingleImageSelector, _extends({
            ...
            shouldDisable: function shouldDisable() {
              return shouldHide || _shouldDisable();
            },
            onNewBundleCreatedBridge: function onNewBundleCreatedBridge(idx, props) {
