...
var StatelessSingleImageSelector = function (_React$Component) {
  ...
  _createClass(StatelessSingleImageSelector, [{
    ...
    value: function render() {
      ...
      var shouldHideImage = SINGLE_UPLOADER_STATE.IDLE == bundle.uploaderState;
      var shouldHideBrowseButton = SINGLE_UPLOADER_STATE.IDLE != bundle.uploaderState || shouldDisable();
